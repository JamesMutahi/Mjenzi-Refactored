    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mjenzi_api.Project')),
            ],
        ),
        migrations.CreateModel(
            name='Requests',
            fields=[
                ...
                ('location', django.contrib.gis.db.models.fields.PointField(srid=4326)),
                ('date_posted', models.DateTimeField(default=django.utils.timezone.now)),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mjenzi_api.Materials')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mjenzi_api.Project')),
            ],
            options={
