...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('project_name', models.EmailField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=django.utils.timezone.now)),
                ('material_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mjenzi_api.Materials')),
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='materials', to='mjenzi_api.Project'),
        ),
    ]
